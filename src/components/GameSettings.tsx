      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="relative z-10 w-full max-w-2xl">
            <Card className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 shadow-2xl max-h-[90vh] overflow-hidden">
              <CardHeader className="relative pb-4 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
                <Button
                  variant="ghost"
                  size="icon"
                  onClick={() => setIsOpen(false)}
                  className="absolute right-2 top-2 h-8 w-8 hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-600 dark:text-gray-400"
                  aria-label="Close settings"
                >
                  <X className="w-4 h-4" />
                </Button>
                <CardTitle className="flex items-center gap-2 text-gray-900 dark:text-gray-100 text-lg pr-8">
                  <Settings className="w-5 h-5 shrink-0" />
                  Cozy Settings
                </CardTitle>
              </CardHeader>
              
              <CardContent className="pb-6 overflow-y-auto max-h-[calc(90vh-120px)] bg-white dark:bg-gray-900">
